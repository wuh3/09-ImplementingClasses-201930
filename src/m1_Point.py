...
# -----------------------------------------------------------------------------
# done          With your instructor, READ THE INSTRUCTIONS in
# done  in file  m0_INSTRUCTIONS.txt, asking questions as needed.
#
# done Then implement a class called   Point that has NO METHODS
# sone  yet, just the lines that start the definition of any class:
#
...
class Point(object):
    ...
    def get_distance_from(self,point):
        ...
        dy=point.y-self.y
        return math.sqrt(dx**2+dy**2)
    def get_distance_from_start(self,point,x,y):
        start=Point(x,y)
        dx=point.x-start.x
        dy=point.y-start.y
        return math.sqrt(dx**2+dy**2)
...
def run_test_repr():
    ...
    """
    # -------------------------------------------------------------------------
    # done  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_get_number_of_moves_made():
    ...
    # done  HINT: What must a Point REMEMBER for this method?
    # -------------------------------------------------------------------------
    print()
    print('-----------------------------------------------------------')
...
def run_test_get_distance_from_start():
    ...
    print()
    print('p1 from start to (21, 31), should be about 1.414')
    print('Actually is:', p1.get_distance_from_start(p1,20,30))
    ...
    print()
    print('p2 from start to (1, 1), should be about 0.0')
    print('Actually is:', p2.get_distance_from_start(p2,1,1))
